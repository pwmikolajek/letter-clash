/*
  # Fix live_placements table policies

  This migration checks if the live_placements table exists and creates it if needed.
  It also ensures policies are created only if they don't already exist.
*/
